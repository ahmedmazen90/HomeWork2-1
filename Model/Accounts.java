...
public class Accounts {
    ...
    private String creation_date;
       ...
       public Accounts(String accountNumber, String userName, String curreny, String balance, String creation_date) {
    ...
    public static ArrayList<Accounts> getAllAccounts() throws SQLException, ClassNotFoundException{
        ...
        rs = ps.executeQuery();
        while (rs.next()){
            Accounts account = new Accounts(rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7));
    ...
    public int update() throws SQLException, ClassNotFoundException{
      ...
      public static ArrayList<Accounts> searchAccountByNumber(String accountNumber) throws SQLException {
       ArrayList<Accounts> accounts = new ArrayList<>();
           Connection c = DB.getInstance().getConnection();
           PreparedStatement ps = null;
            ...
            Accounts account = new Accounts(accountnumber,userName,curreny,balance,creationDate);
            account.setId(id);
